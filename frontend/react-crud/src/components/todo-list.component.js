                ...
                <div className="col-md-6">
                    {currentTodo ?(
                        <div>
                            ...
                            <button                    
                                type="button"
                                className={(currentTodo.favor === true ? "btn btn-warning":"btn btn-outline-warning")}
                                id='favoritebutton'
                                onClick={()=> this.setFavorite(currentTodo,(currentTodo.favor === true ? false:true))}
                            >
                                {(currentTodo.favor === true ? "unfavorite":"favorite")}
                            </button>
                        </div>
